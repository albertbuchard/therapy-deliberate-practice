...
const MicIcon = ({ active }: { active: boolean }) => (
  <svg
    ...
    className={active ? "text-rose-100" : "text-teal-100"}
  >
...
export const BigMicButton = ({
  ...
  return (
    <button
      ...
      disabled={isDisabled}
      className={`group relative flex h-36 w-36 items-center justify-center rounded-full border text-white transition-all duration-300 ${
        isRecording
      ...
      <svg className="absolute h-[110px] w-[110px] -rotate-90">
        ...
        {progressClamped > 0 && (
          <circle
            ...
            cy="55"
            r="46"
            stroke={isRecording ? "rgba(248,113,113,0.9)" : "rgba(94,234,212,0.9)"}
            strokeWidth="6"
            fill="transparent"
